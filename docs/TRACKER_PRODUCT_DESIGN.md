...
Keep `data/applications.md` as the main user-facing table.
...
1. Keep `data/applications.md` compatible and layer `Next Action` / `Due` through `data/application-events.jsonl`.
