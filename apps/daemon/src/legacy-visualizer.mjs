...
import { registerEvidenceRoutes } from '../../../visualizer/services/evidence-service.mjs';
import { registerExperienceMetadataRoutes } from '../../../visualizer/services/experience-metadata-service.mjs';
import { registerExperienceProfileRoutes } from '../../../visualizer/services/experience-profile-service.mjs';
import { registerWorkspaceRoutes } from '../../../visualizer/services/workspace-service.mjs';
...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (url.pathname === '/health') return sendJson(res, { ok: true, service: 'offeru-daemon' });
...
server.listen(port, () => {
  console.log(`OfferU daemon: http://localhost:${port}`);
});
