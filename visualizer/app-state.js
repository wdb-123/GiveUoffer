...
const resumeGenerationStatus = document.querySelector('#resumeGenerationStatus');
const resumeTargetJobSelect = document.querySelector('#resumeTargetJobSelect');
...
const applicationTodos = document.querySelector('#applicationTodos');
const applicationFeedback = document.querySelector('#applicationFeedback');
...
const experienceProfileGenerateBtn = document.querySelector('#experienceProfileGenerateBtn');
...
const experienceProfileList = document.querySelector('#experienceProfileList');
...
let currentExperienceProfile = null;
...
let currentResumeGenerationJobId = '';
let currentResumeTargetJobId = '';
let currentResumePageIndex = 0;
