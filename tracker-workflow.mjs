 ...
 *
 * Keeps data/applications.md as the human-facing tracker and layers a
 ...
 *   node tracker-workflow.mjs --add-event 12 --event applied --next-action "Follow up" --due 2026-06-10 --note "Submitted via company site"
 *   node tracker-workflow.mjs --parse-email email.txt
 */
...
const EVENTS_FILE = join(ROOT, 'data/application-events.jsonl');
