...
import { readRecruitmentMarket } from '../recruitment-market-store.mjs';

const marketPath = 'data/recruitment-market.json';
...
const clusterDefs = [
  {
    ...
    resume: 'resumes/01-robotics-system-engineer.md',
  ...
  },
  {
    ...
    resume: 'resumes/02-robotics-software-sdk-engineer.md',
  ...
  },
  {
    ...
    resume: 'resumes/04-embodied-data-infra-engineer.md',
  ...
  },
  {
    ...
    resume: 'resumes/06-enterprise-ai-rag-engineer.md',
  ...
  },
  {
    ...
    resume: 'resumes/03-embodied-ai-application-engineer.md',
