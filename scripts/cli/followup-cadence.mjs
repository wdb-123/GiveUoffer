#!/usr/bin/env node
/**
 * followup-cadence.mjs — Follow-up Cadence Tracker for Ucareer
 *
 ...
 *
 * Run: npm run followup --             (JSON to stdout)
 *      npm run followup -- --summary   (human-readable dashboard)
 *      npm run followup -- --overdue-only
 *      npm run followup -- --applied-days 10
 */
...
const FOLLOWUPS_FILE = join(CAREER_OPS, 'workspace/ops/data/follow-ups.md');
