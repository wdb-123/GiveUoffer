...
SRC_PHOTO = ROOT / "workspace" / "profile" / "headshots" / "职业照.jpg"
CROPPED = ROOT / "workspace" / "profile" / "headshots" / "职业照_简历头像_圆角4x5.png"
RESUME_SOURCE_DIR = ROOT / "workspace" / "resumes" / "source"

DOCS = [
    (
        RESUME_SOURCE_DIR / "韦东波_简历.docx",
        RESUME_SOURCE_DIR / "韦东波_简历_带职业照.docx",
    ),
    (
        RESUME_SOURCE_DIR / "韦东波_机器人系统工程师_优化排版完整版.docx",
        RESUME_SOURCE_DIR / "韦东波_机器人系统工程师_带职业照.docx",
    ),
]
