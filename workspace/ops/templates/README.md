...
**Design:** Space Grotesk headings + DM Sans body, single-column ATS-safe layout, self-hosted fonts from `workspace/ops/templates/fonts/`.

**Customization:** Edit this file to change colors, spacing, or section order. The placeholder tokens are the `{{...}}` values used by the resume generation scripts.
...
npm run latex -- workspace/ops/exports/cv-name-company-date.tex

# Or specify a custom output path
npm run latex -- workspace/ops/exports/cv-name-company-date.tex workspace/ops/exports/custom-name.pdf
```
