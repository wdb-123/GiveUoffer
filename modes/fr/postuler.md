...
3. RECHERCHER   -> Matcher avec les reports existants dans workspace/jobs/reports/
...
2. Chercher dans `workspace/jobs/reports/` par nom d'entreprise (Grep case-insensitive)
...
5. **Ucareer proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/ucareer contacto` pour du LinkedIn outreach vers le hiring manager
