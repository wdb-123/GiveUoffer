# Contexte partage -- Ucareer (Francais)

<!-- ============================================================
     PERSONNALISATION DE CE FICHIER
     ============================================================
     Ce fichier contient le contexte partage pour tous les modes
     Ucareer en version francaise. Avant d'utiliser Ucareer, tu DOIS :
...
|---------|--------|-------|
| workspace/profile/cv.md | `workspace/profile/cv.md` | TOUJOURS |
...
9. **Entrees tracker en TSV** -- NE JAMAIS editer applications.md directement pour de nouveaux ajouts. Ecrire le TSV dans `workspace/ops/batch/tracker-additions/`, `merge-tracker.mjs` gere la fusion
